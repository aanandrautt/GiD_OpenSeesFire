...
begin
    ...
    // Concrete
        ...
        WriteResults(false,
                     false,'Reading ShellMITC4 damage indices for layer '+IntToStr(i)+' ',
                           'ShellMITC4_temp_damage_Layer'+IntToStr(i),'ShellMITC4','DtDcT (L'+IntToStr(i)+')',
                           'Dt','Dc','T','','','','-',4,4,true,2,3,0,-1,-1,-1);
    ...
    // Steel
        WriteResults(false,
                     false,'Reading ShellMITC4 steel stresses for layer '+IntToStr(i)+' ',
                           'ShellMITC4_steel_stress_Layer'+IntToStr(i),'ShellMITC4','Steel-stress (L'+IntToStr(i)+')',
                           's11','','','','','','kPa',4,1,true,0,-1,-1,-1,-1,-1);
        WriteResults(false,
                     false,'Reading ShellMITC4 steel strains for layer '+IntToStr(i)+' ',
                           'ShellMITC4_steel_strain_Layer'+IntToStr(i),'ShellMITC4','Steel-strain (L'+IntToStr(i)+')',
                           'e11','','','','','','-',4,1,true,0,-1,-1,-1,-1,-1);
        WriteResults(false,
                     false,'Reading ShellMITC4 steel temperature for layer '+IntToStr(i)+' ',
                           'ShellMITC4_steel_temp_Layer'+IntToStr(i),'ShellMITC4','Steel-Temp (L'+IntToStr(i)+')',
                           'T','Elong','','','','','-',4,2,true,0,1,-1,-1,-1,-1);
    end;
    ...
    // Concrete
        ...
        WriteResults(false,
                     false,'Reading ShellDKGQ damage indices for layer '+IntToStr(i)+' ',
                           'ShellDKGQ_temp_damage_Layer'+IntToStr(i),'ShellDKGQ','DtDcT (L'+IntToStr(i)+')',
                           'Dt','Dc','T','','','','-',4,4,true,2,3,0,-1,-1,-1);
    ...
    // Steel
        WriteResults(false,
                     false,'Reading ShellDKGQ steel stresses for layer '+IntToStr(i)+' ',
                           'ShellDKGQ_steel_stress_Layer'+IntToStr(i),'ShellDKGQ','Steel-stress (L'+IntToStr(i)+')',
                           's11','','','','','','kPa',4,1,true,0,-1,-1,-1,-1,-1);
        WriteResults(false,
                     false,'Reading ShellDKGQ steel strains for layer '+IntToStr(i)+' ',
                           'ShellDKGQ_steel_strain_Layer'+IntToStr(i),'ShellDKGQ','Steel-strain (L'+IntToStr(i)+')',
                           'e11','','','','','','-',4,1,true,0,-1,-1,-1,-1,-1);
        WriteResults(false,
                     false,'Reading ShellDKGQ steel temperature for layer '+IntToStr(i)+' ',
                           'ShellDKGQ_steel_temp_Layer'+IntToStr(i),'ShellDKGQ','Steel-Temp (L'+IntToStr(i)+')',
                           'T','Elong','','','','','-',4,2,true,0,1,-1,-1,-1,-1);
