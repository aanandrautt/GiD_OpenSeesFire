*format "%d%d%g%g%g"
nDMaterial PressureDependMultiYield02 *MaterialID *ndime *MatProp(Saturated_soil_mass_density,real) *MatProp(Reference_shear_modulus_Gr,real) *MatProp(Reference_bulk_modulus,real) *\
*format "%g%g%g%g"
...
*format "%g%g%g%g%g"
*MatProp(Phase_transformation_angle,real) *MatProp(Contraction_constant_1,real) *MatProp(Contraction_constant_3,real) *MatProp(Dilation_rate_constant_1,real) *MatProp(Dilation_rate_constant_3,real) *\
...
*endif
*format "%g%g"
*MatProp(Contraction_constant_2,real) *MatProp(Dilation_rate_constant_2,real)
*format "%g%g"
*MatProp(Liquefaction_parameter_1,real) *MatProp(Liquefaction_parameter_2,real) *\
*format "%g%g%g%g%g%g"
